...
if [ ! -d curl ]; then
    ...
    cmake \
        ...
        -DBUILD_TESTING=Off \
        -DBUILD_CURL_EXE=Off \
        -DZLIB_LIBRARY=/usr/local/arm-linux-gnueabihf/lib/libz.a \
        -DOPENSSL_SSL_LIBRARY=/usr/local/arm-linux-gnueabihf/lib/libssl.a \
        -DOPENSSL_CRYPTO_LIBRARY=/usr/local/arm-linux-gnueabihf/lib/libcrypto.a \
