...
public class Elm327 {
    ...
    private static final int TIMEOUT_RESET = 2000; // ms
    private static final int TIMEOUT_SETUP = 500; // ms
    private static final int TIMEOUT_OBD = 500; // ms
    private static final int TIMEOUT_POLL = 50; // ms
    ...
    void connect(String deviceParam)
    {
        ...
        try {
            ...
            List<String> res = sendCommand(CMD_RESET, TIMEOUT_RESET);
            if (res == null) {
            ...
            res = sendCommand(CMD_SET_PROTOCOL_AUTO, TIMEOUT_SETUP);
            if (res == null) {
    ...
    public String sendObdRequest(String request) {
        ...
        List<String> res = sendCommand(request, TIMEOUT_OBD);
